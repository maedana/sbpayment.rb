...
module Sbpayment
  module API
    module Credit
      class CreateCustomerTokenForEternityTokenRequest < Request
        class PayMethodInfo
      ...
      class CreateCustomerTokenForEternityTokenResponse < Response
        DECRYPT_PARAMETERS = %i(res_pay_method_info.tokenized_pan res_pay_method_info.cardbrand_code).freeze
      end
    end
  end
end
